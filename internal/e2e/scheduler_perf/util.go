...
func mustSetupScheduler(ctx context.Context, b *testing.B, config *config.KubeSchedulerConfiguration, outOfTreePluginRegistry frameworkruntime.Registry) (util.ShutdownFunc, coreinformers.PodInformer, clientset.Interface, dynamic.Interface) {
...
func dataItems2JSONFile(dataItems DataItems, namePrefix string) error {
	...
	return os.WriteFile(destFile, formatted.Bytes(), 0o644)
}
