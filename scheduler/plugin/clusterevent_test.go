...
func TestEncodeClusterEvents(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: []framework.ClusterEvent{{Resource: framework.Node, ActionType: framework.Add, Label: "NodeAdd"}},
		},
		{
			...
			expected: []framework.ClusterEvent{
				{Resource: framework.Node, ActionType: framework.UpdateNodeLabel | framework.UpdateNodeCondition, Label: "NodeAdd"},
			},
		},
		{
			name: "two",
		...
		},
		{
			...
			expected: []framework.ClusterEvent{{Resource: framework.Node, ActionType: framework.Add, Label: "fóo"}},
		},
	}
