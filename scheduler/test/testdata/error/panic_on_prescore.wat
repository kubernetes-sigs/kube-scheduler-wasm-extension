;; panic_on_prescore is a prescore which issues an unreachable instruction
;; after writing and error to stdout. This simulates a panic in TinyGo.
(module $panic_on_prescore
  ...
  ;; On prescore, write "panic!" to stdout and crash.
  (func (export "prescore") (result i32)
