;; panic_on_prebind is a prebind which issues an unreachable instruction
;; after writing an error to stdout. This simulates a panic in TinyGo.
(module $panic_on_prebind
  ...
  ;; On prebind, write "panic!" to stdout and crash.
  (func (export "prebind") (result i32)
  ...
  ;; We require exporting bind with prebind
