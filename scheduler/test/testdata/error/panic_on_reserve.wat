;; panic_on_reserve is a reserve which issues an unreachable instruction
;; after writing an error to stdout. This simulates a panic in TinyGo.
(module $panic_on_reserve
  ...
  ;; On reserve, write "panic!" to stdout and crash.
  (func (export "reserve") (result i32)
  ...
  ;; We require exporting reserewith reserve
