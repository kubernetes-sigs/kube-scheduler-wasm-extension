;; panic_on_filter is a filter which issues an unreachable instruction
;; after writing and error to stdout. This simulates a panic in TinyGo.
(module $panic_on_filter
  ...
  ;; On filter, write "panic!" to stdout and crash.
  (func $filter (export "filter") (result i32)
